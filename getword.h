...
*
*   IMPORTANT: unlike Program0, repeated characters do NOTHING weird/special!

Upon return, the string pointed to by w contains the next word in the line from
stdin. A "word" is a string containing a single metacharacter or a string made
up of non-metacharacters delimited by EOF, newline, blank, or metacharacters.
...
Null>!void
will return 4,2,4 and create the strings "Null", ">!", and "void", respectively.
